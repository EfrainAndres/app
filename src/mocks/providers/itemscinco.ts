...
export class Itemscinco {
  ...
  defaultItemcinco: any = {
    "name": "Bateria",
    "profilePic": "assets/img/mantenimiento7000.jpg",
  ...
  constructor(public http: Http) {
    let itemscinco = [
      ...
      },
      {
        ...
        "img":"assets/img/antena-5000.jpg",
        "recomendacion": "¡Recomendación!",
      ...
      },
      {
        ...
        "img": "assets/img/potencia-5000.jpg",
        "recomendacion": "¡Recomendación!",
        "descripman": "Para evitar el daño del conector, protéjalo con la cubierta de conector cuando no lo utilice.",
        "img2":"assets/img/potencia-5000-2.jpg",
        "img3":"assets/img/potencia-5000-3.jpg",
        "pregunta":"¿Le quedo alguna duda, de como colocar la antena en el radio?. A continuación, encontrara un video relacionado a este tema.",
        "video":"https://www.youtube.com/embed/PyB81R9j1pk",
      },
      {
      ...
      },
      {
        ...
        "img3":"assets/img/display-5000-3.jpg",
